...
func searchEstateNazotte(c echo.Context) error {
	...
	query := fmt.Sprintf(`SELECT %s FROM isuumo.estate WHERE ST_Contains(ST_PolygonFromText(%s), point) ORDER BY popularity DESC, id ASC`, estateColumns, coordinates.coordinatesToText())
